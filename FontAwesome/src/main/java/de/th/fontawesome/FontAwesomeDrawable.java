...
public class FontAwesomeDrawable extends Drawable {
     ...
     * de.th.fontawesome.FontAwesomeDrawable cannot properly measure the bounds this drawable will need.
     * You must call {@link #setBounds(int, int, int, int) setBounds()} before
     * applying this de.th.fontawesome.FontAwesomeDrawable to any View.
     * <p>
