...
// https://blog.blundellapps.co.uk/tut-programmatically-create-a-rippledrawable-of-any-color/

// myButton.setBackground(RippDrawable.getSelectableDrawableFor(Color.parseColor("#ff0000"));

public class RippDrawable {
